    ...
    _.forEach(self.entries, function(entry, index) {
      ...
      switch (entry.typeName) {
        case 'webforms.WebForm':
          userField        = _.find(entry.secureContents.fields, function(f) { return f.name === 'username'; });
          pwField          = _.find(entry.secureContents.fields, function(f) { return f.name === 'password'; });
